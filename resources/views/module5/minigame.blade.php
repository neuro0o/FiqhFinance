...
@section('title', 'Module 5 Mini Game')
    ...
    <div class="game-content">
        <div class="game-header">
            <h1>
                ...
                Module 5: Drag & Drop Scenario Quiz!
            </h1>
            <p>Click it. Drag it. Drop it!</p>
        </div>

        <form id="dragDropForm" action="{{ route('module5.minigame.submit') }}" method="POST">
            @csrf
            ...
            <div class="game-actions">
                ...
                <a href="{{ route('module5.note') }}" class="btn btn-back">Back to Home</a>
            </div>
        </form>
    </div>
@endsection
