...
@section('title', 'Module 5 Score')

@section('page-css')
    <link rel="stylesheet" href="{{ asset('css/utils/sidebar.css') }}">
    <link rel="stylesheet" href="{{ asset('css/moduleMiniGame/moduleMiniGame5.css') }}">
@endsection
...
@section('content')
    ...
    <div class="score-content">
        <h1>Module 5: Result</h1>

        @if(!$result || !isset($result['score']))
            <div class="alert alert-info">No result available. Try the minigame first.</div>
            <a href="{{ route('module5.minigame') }}" class="btn btn-primary">Start Game</a>
        @else
            <div style="margin-top:1rem;">
                ...
                @else
                    <p class="no-badge">You didn't earn a badge this time.<br>Try to get at least <strong>6/10</strong> to earn <strong>Halal Investor</strong>!</p>
                @endif
                ...
                <div class="score-button">
                    <a href="{{ route('module5.minigame') }}" class="btn btn-primary">Play Again</a>
                    <a href="{{ route('module5.note') }}" class="btn btn-secondary">Back to Notes</a>
                </div>
            </div>
        @endif
    </div><br><br><br><br>
