  ...
  <nav id="sidebar">
    <ul>
      ...
      <li>
        ...
        <span class="logo">FiqhFinancce</span>
      ...
      <li>
        ...
        <ul class="sub-menu">
            <div>
              <li><a href="{{ route('module1.note') }}">Introduction to Islamic Finance</a></li>
              <li><a href="{{ route('module2.note') }}">Shariah Principles in Islamic Finance</a></li>
              <li><a href="{{ route('module3.note') }}">Islamic Banking Products</a></li>
              <li><a href="{{ route('module4.note') }}">Takaful</a></li>
              <li><a href="{{ route('module5.note') }}">Islamic Investment</a></li>
              <li><a href="{{ route('module6.note') }}">Islamic Financial Planning</a></li>
            </div>
          </ul>
      </li>
